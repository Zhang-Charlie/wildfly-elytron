...
public final class PemKeyStoreSpi extends KeyStoreSpi {
    ...
    public void engineLoad(KeyStore.LoadStoreParameter param) throws IOException, NoSuchAlgorithmException, CertificateException {
        ...
        PemKeyStoreUtil.PemEntries certificateEntries;
        PemKeyStoreUtil.PemEntries privateKeyEntries;
        try (InputStream certificateStream = Files.newInputStream(pemParameter.getCertificatePath());
                InputStream privateKeyStream = Files.newInputStream(pemParameter.getPrivateKeyPath())) {
            certificateEntries = PemKeyStoreUtil.loadPemEntries(certificateStream);
            privateKeyEntries = PemKeyStoreUtil.loadPemEntries(privateKeyStream);
        }
        ...
        keyStore = PemKeyStoreUtil.createKeyStore(new PemKeyStoreUtil.PemEntries(privateKey, certificates), pemParameter.getAlias(), getPassword(pemParameter));
    }
